...
<input type = "button" id = "shuffle" value = "셔플ON" onclick = "addShuffle(this);">
<input type = "button" id = "previous" value = "이전 곡" onclick = "palyPrevious();">
<input type = "button" id = "play" value = "재생" onclick = "musicPlay();">
<input type = "button" id = "next" value = "다음 곡" onclick = "playNext();">
<input type = "button" id = "loop" value = "반복 없음" onclick = "addLoop();">
<label>재생 바</label>
<input type = "button" id = "mute" value = "음소거" onclick = "mute(this);">
...
audio.addEventListener("timeupdate", () => {
	var progressBar = opener.document.getElementById("progressBar");

...
if (signedinDto.getMemberId()!=0){
	...
	<a href="/semi2/mypage/profile.jsp"><img src="/semi2/resources/images/member/<%=signedinDto.getMemberId() %>/profile.jpg?v=<%=System.currentTimeMillis()%>" class="login-profile-image" onerror="this.src='/semi2/resources/images/member/default-profile.jpg';"></a>
	</div>

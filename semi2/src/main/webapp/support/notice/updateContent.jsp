...
%>
<div class="subtitle"><h2>공지사항 게시글 수정</h2></div>
<form name="writeForm" action="/semi2/support/notice/updateContent_ok.jsp" method="post">
<div class="support-write-box">
<div class="support-write-title">
<input name="title" type="text" value="<%=noticeDto.getTitle()%>">

</div>
<div class="support-write-content">
<textarea name="content"><%=noticeDto.getContent()%></textarea>
</div>
...
<input type="hidden" name="id" value="<%=noticeDto.getId()%>">
